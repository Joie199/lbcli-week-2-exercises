...
rawtxhex=$(bitcoin-cli -regtest createrawtransaction '[{"txid":"'$TXID'","vout":0,"sequence":1},{"txid":"'$TXID'","vout":1,"sequence":1}] {"2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP":0.23659108}')
echo $rawtxhex
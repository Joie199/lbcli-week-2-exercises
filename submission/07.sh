...
RAW_TX=$(bitcoin-cli -regtest createrawtransaction '[{"txid":"'"$TXID"'","vout":0},{"txid":"'"$TXID"'","vout":1}]' '{"2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP":0.20000000,"'"$CHANGE_ADDRESS"'":0.03658100}')
echo "$RAW_TX"